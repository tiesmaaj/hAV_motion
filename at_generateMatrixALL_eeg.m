function [data_output] = at_generateMatrixALL_eeg(catchtrials, congruent_mstrials, incongruent_mstrials, stimtrials, audInfo, visInfo, right_var, left_var, catch_var, cued_nature, coh_nature)
...
for i = 1:length(audInfo.cohSet)
    ...
    % Auditory only trials    % Congruent trials
