...
dur = 0.7; Fs = 44100; triallength = 2; nbblocks = 0; 
...
num_trials = 250; stimtrials = [20, 0, 0]; catchtrials = 20;
...
elseif task_nature == 2 % Method of constant stimuli
    ...
    elseif stim_matching_nature == 3
        ...
        all_trials = [1 1; 2 2; 1 1; 2 2; 1 1; 2 2; 1 1; 2 2];
...
%% Welcome and Instructions for the Suject
...
for i = 1:size(data_output, 1)
    if data_output(i, 1) == data_output(i, 3)
