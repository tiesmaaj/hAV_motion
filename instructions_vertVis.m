function instructions_vertVis(curWindow, cWhite0)
...
Screen('DrawText', curWindow, 'Your task is to report the direction (UP or DOWN) of a stimulus.',300,500,cWhite0);
...
Screen('DrawText', curWindow, 'pressing UP ARROW on the box for upward motion or DOWN ARROW on the box for downward motion',300,500,cWhite0);
Screen('DrawText', curWindow, 'Press any key to continue...',300,650,cWhite0);
Screen('Flip',curWindow);
keytest_unbound;
