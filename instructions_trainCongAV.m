function instructions_trainCongAV(curWindow, cWhite0, pahandle, corr_soundout, incorr_soundout)

% Instructions 2
Screen('DrawText', curWindow, '...Welcome to this experiment...',500,300,cWhite0);
Screen('DrawText', curWindow, 'This is a motion discrimination task. Your job is to determine',300,400,cWhite0);
Screen('DrawText', curWindow, 'if the direction of the motion is the SAME between what you see and what you hear.',300,500,cWhite0);
...
Screen('DrawText', curWindow, 'Your task is to indicate if the directions of motion on EACH TRIAL are the same or different by',300,400,cWhite0);
Screen('DrawText', curWindow, 'pressing S on the box for same motion directions or D on the box for different motion directions',300,500,cWhite0);
Screen('DrawText', curWindow, 'Press any key to continue...',300,650,cWhite0);
Screen('Flip',curWindow);
keytest_unbound;
