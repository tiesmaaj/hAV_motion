...
cong_nature = input('Coherence Manipulation = 1;  Congruency Manipulation = 2 : ');
if cong_nature == 1
    
elseif cong_nature == 2
    coherence_nature = input('Coherence Level? (0 to 100) : ');
end
...
congruent_keypress = [115 13 40]; % 1 on button box
incongruent_keypress = [114 12 39]; % 0 on button box
...
congruent_mstrials = 10; incongruent_mstrials = 10;
...
visInfo.dirSet = [0 45 90 135 180];
audInfo.dirSet = [0 180];
audInfo.cohSet = coherence_nature; visInfo.cohSet = coherence_nature;
catchtrials = 24;
incongruent_mstrials = 12;
%[data_output] = at_generateMatrixCONG(catchtrials, incongruent_mstrials, audInfo, visInfo);
all_trials = [0 100 0 100; 0 100 45 100; 0 100 90 100; 0 100 135 100; 0 100 180 100
    180 100 0 100; 180 100 45 100; 180 100 90 100; 180 100 135 100; 180 100 180 100];
...
for ii = 1:length(data_output)
   ...
   %% AV Stimuli Presentation
    ...
    [data_output] = record_congAVdata(data_output, right_var, left_var, congruent_keypress, incongruent_keypress, audInfo, visInfo, resp, rt, ii, cong_var, incong_var);
