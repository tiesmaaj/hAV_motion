function instructions_psyVis(curWindow, cWhite0)
...
Screen('DrawText', curWindow, 'pressing LEFTWARD ARROW on the box for leftward motion or RIGHTWARD ARROW on the box for rightward motion',300,500,cWhite0);
Screen('DrawText', curWindow, 'Press any key to continue...',300,650,cWhite0);
Screen('Flip',curWindow);
keytest_unbound;
