...
function [CAM, N3] = makeCAM_ANG(cLvl, direction, dur, silence, Fs, noise_reduction_scalar, noise_jitter_nature)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Convert direction from degrees to 1 or 2
if direction == 180
    direction = 1;
elseif direction == 0 && cLvl ~= 0
    direction = 2;
else
    warning('Incorrect auditory coherence input into makeCAM!!!');
end

% Convert coherence from percent to  0-1
cLvl = cLvl / 100;
