function instructions_psyAV(curWindow, cWhite0, sliderResp_nature)
...
Screen('DrawText', curWindow, 'pressing the left arrow on the box for leftward motion or the right arrow on the box for rightward motion',300,500,cWhite0);
Screen('DrawText', curWindow, 'Press any key to continue...',300,650,cWhite0);
Screen('Flip',curWindow);
keytest_unbound;
